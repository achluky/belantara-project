...
class Undergraduate_outbound {
    ...
    public function view(){
        $this->controller->load->model("model_wcu_internasionalization_undergraduate_outbound");
        $data = array(
                    'url'=> current_url(),
        ...
        $this->controller->smartyci->display('frontend/view/undergraduate_outbound.tpl');
    }
    public function list_(){
        ...
        $list = $this->controller->model_wcu_internasionalization_undergraduate_outbound->get_datatables($this->table, $this->column, $this->order, $id);
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->controller->model_wcu_internasionalization_undergraduate_outbound->count_all($this->table, $id),
            "recordsFiltered" => $this->controller->model_wcu_internasionalization_undergraduate_outbound->count_filtered($this->table, $this->column, $this->order, $id),
            "data" => $data
        );
