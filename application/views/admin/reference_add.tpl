          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  <div class="box-header">
                    <h3 class="box-title">Add References</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body box-primary">

                      <form role="form" data-toggle="validator" class="form-horizontal" action="{base_url()}adminreference/save" name="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                              <label for="inputPassword3" class="col-sm-2 control-label">File PDF</label>
                              <div class="col-sm-10">
                                    ...
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                      ...
                                      <input type="file" name="pdf" value="" required></span>
                                      <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
                                    </div>
                                    <i class="text-danger">Berekstensi .pdf</i>
                              </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
