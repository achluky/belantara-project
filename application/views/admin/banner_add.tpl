          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body box-primary">
                      ...
                      <form role="form" data-toggle="validator" class="form-horizontal" action="{base_url()}banner/save" name="" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="input" class="form-control" id="link" name="link" placeholder="Link" value="" required>
                              </div>
                            </div>
