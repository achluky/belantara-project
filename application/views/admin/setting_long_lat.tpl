              ...
              {if isset($data.alert) and ($data.alert != '')}
                ...
                <div class="block">
                  <div class="block-title">
                    <h2>{lang('navigation.navbar.setting.longlat')}</h2>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body box-primary">
                      <form role="form" data-toggle="validator" class="form-horizontal" action="{base_url()}setting/longlat/act" name="" method="POST">
