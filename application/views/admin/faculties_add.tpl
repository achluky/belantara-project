          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  <div class="box-header">
                    <h3 class="box-title">Add Faculties</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body box-primary">

                      <form role="form" data-toggle="validator" class="form-horizontal" action="{base_url()}faculties/save" name="" method="POST" enctype="multipart/form-data">                       
                        <div class="box-body">
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="background_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Latar Belakang" name="content_background_ID" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="background_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Latar Belakang" name="content_background_EN" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="competence_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Kompetensi" name="content_competence_ID" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="competence_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Kompetensi" name="content_competence_EN" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="quality_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Kebijakan Mutu" name="content_quality_ID" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="quality_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Kebijakan Mutu" name="content_quality_EN" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="education_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Program Pendidikan" name="content_education_ID" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="education_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Kebijakan Mutu" name="content_education_EN" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="facilities_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Fasilitas" name="content_facilities_ID" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="facilities_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Fasilitas" name="content_facilities_EN" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="research_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Penelitian dan Pengabdian" name="content_research_ID" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="research_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Penelitian dan Pengabdian" name="content_research_EN" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" rows="3" placeholder="Isi Alamat" name="address" required></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="inputPassword3" class="col-sm-2 control-label">URI</label>
                              <div class="col-sm-10">
                                <input type="input" class="form-control" id="keyword" placeholder="URI" name="uri" value="" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="inputPassword3" class="col-sm-2 control-label">Kode Fakultas</label>
                              <div class="col-sm-10">
                                <input type="input" class="form-control" id="keyword" placeholder="Isi Kode Fakultas" name="code" value="" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="inputPassword3" class="col-sm-2 control-label">Singkatan Fakultas</label>
                              <div class="col-sm-10">
                                <input type="input" class="form-control" id="keyword" placeholder="isi Singkatan Fakultas" name="singkatan" value="" required>
                              </div>
                            </div>
                            <div class="form-group">
