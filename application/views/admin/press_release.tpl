          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  <div class="box-header">
                    ...
                    <a href="{base_url()}adminpressrelease/add"class="btn btn-primary" style="float:right;"><i class="glyphicon glyphicon-plus-sign"></i> Add Press Release</a>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
  ...
  <script>
      $(function () {
        table = $('#example1').DataTable({
          ...
          "ajax": {
              "url": "{base_url()}adminpressrelease/press_release_list",
              "type": "POST"
          },
