          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body box-primary">
                      <form class="form-horizontal" action="{base_url()}adminrelatednews/update" name="" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="input" class="form-control" id="link" name="link" placeholder="Link" value="{$data.news->isi}" required>
                              </div>
                            </div>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                              <label for="inputPassword3" class="col-sm-2 control-label">&nbsp;</label>
                              <a href="{base_url()}adminrelatednews">{$data.label.news_cancel}</a>
