        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body box-primary">
                    <form role="form" data-toggle="validator" class="form-horizontal" action="{base_url()}socmed/update" name="" method="POST">
                        <input type="hidden" class="form-control" id="id" name="id" value="{$data.socmed->id}">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Nama</label>
                                <div class="col-sm-10">
                                    <input type="input" class="form-control" id="nama" name="nama" placeholder="Nama Social Media" value="{$data.socmed->nama}" required>
                                </div>
                            </div> 
							<div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Link</label>
                                <div class="col-sm-10">
                                    <input type="input" class="form-control" id="link" name="link" placeholder="Link Social Media" value="{$data.socmed->link}" required>
                                </div>
                            </div>	
							<div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Urutan</label>
                                <div class="col-sm-10">
                                    <input type="input" class="form-control" id="urutan" name="urutan" placeholder="Link Social Media" value="{$data.socmed->urutan}" required>
                                </div>
                            </div>							
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Icon</label>
                                <div class="col-sm-10">
                                    <input type="input" class="form-control" id="icon" name="icon" placeholder="Icon Social Media" value="{$data.socmed->icon}" required>
                                    <br/>
                                    <h3><i class="{$data.socmed->icon} fa-3"></i></h3>                              
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
