          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body box-primary">
                      ...
                      <form role="form" data-toggle="validator" class="form-horizontal" action="{base_url()}campus/save" name="" method="POST" enctype="multipart/form-data">                       
                        <div class="box-body">
                            <div class="form-group">
                              <label for="inputEmail3" class="col-sm-2 control-label">Nama</label>
                              <div class="col-sm-10">
                                <input type="input" class="form-control" id="nama" name="nama_en" placeholder="Judul English" value="" required>
                              </div>
                            </div>
                            <div class="form-group">
							  <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
                              <div class="col-sm-10">
                                <input type="input" class="form-control" id="nama" name="nama" placeholder="Judul Indonesia" value="" required>
                              </div>
                            </div>
							<div class="form-group">
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="background_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Alamat" name="alamat" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="background_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Alamat" name="alamat_en" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Tentang Kampus" name="isi" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="tab_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Tentang Kampus" name="isi_en" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
