          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body box-primary">
                      <form class="form-horizontal" action="{base_url()}adminreference/update" name="" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                      ...
                                      <input type="input" name="pdf" value="{$data.news->isi}">
                                      </span>
