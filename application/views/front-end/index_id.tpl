...
<div id="slider" class="inspiro-slider arrows-large arrows-creative dots-creative" data-height-xs="360">
            ...
            <div class="container">
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                      <h2 >Mengenai Kami</h2>
                      <p class="m-b-10">Yayasan Bersama Lestarikan Nusantara (“Yayasan Belantara”) adalah sebuah lembaga pembuat hibah yang dibentuk pada tahun 2014 dengan tujuan memberikan hasil masyarakat dan konservasi yang lebih luas. Nama Belantara diambil dari Bahasa Indonesia yang berarti hutan belantara atau hutan yang masih alami.</p>
                      <p>Fokus utama dari Belantara adalah untuk mengalokasi hibah untuk mendukung pemulihan, perlindungan dan konservasi spesies yang terancam punah (khususnya Harimau Sumatera, Gajah Sumatera, serta Orangutan Sumatera dan Kalimantan), pengembangan kelembagaan, dan inisiatif pengembangan dan pemberdayaan masyarakat di Kawasan Konservasi, Hutan Produksi, Hutan Lindung dan Kehutanan Sosial di kesepuluh wilayah distribusi hibah yang telah ditentukan dan berada di lima propinsi di Pulau Sumatera dan Kalimantan.</p>
                  </div>  
            ...
            <div class="p-t-80">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <h2>PENDEKATAN MULTI PIHAK : <span class="text-green">MENYATUKAN BAGIAN-BAGIANNYA</span></h2>
                        <hr>
                        <p>Inti dari pendekatan Belantara adalah memfasilitasi forum multipihak dari bawah ke atas. Melalui forum tersebut, para pemangku kepentingan yang berada di dalam ekosistem dimungkinkan untuk tidak saja merancang rencana konservasi jangka panjang yang berkelanjutan, namun juga dapat mendukung kebutuhan ekonomi mereka. Ini menempatkan masyarakat lokal, otoritas pemerintah, LSM dan sektor bisnis sebagai aktor kunci dalam  perubahan tersebut.</p>
        ...
        <section class="p-t-50 background-1">
            <div class="container">
                <h3 class="text-center">PETA DISTRIBUSI HIBAH</h3>
