...
<div id="slider" class="inspiro-slider arrows-large arrows-creative dots-creative" data-height-xs="360">
    ...
    <!-- Slide 2 -->
    <div class="slide background-overlay-one kenburns" style="background-image:url('{base_url()}assets/front-end/images/slider/monyet.jpg');">
        <div class="container">
            <div class="slide-captions">
                <!-- Captions -->
                <h1 data-caption-animation="zoom-out">Conserve <br> Indonesia's<br>Natural</br>Environment</h1>
...
<section>
    <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6">
              ...
              <p class="m-b-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero quod conseqt quibusdam, enim expedita sed quia nesciunt incidunt accusamus necessitatibus modi adipisci officia libero accusantium esse hic, obcaecati, ullam, laboriosam!</p>
              <p class="m-b-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti vero, animi suscipit id facere officia. Aspernatur, quo, quos nisi dolorum aperiam fugiat deserunt velit rerum laudantium cum magnam.</p>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            <video class="text-center" width="100%" height="100%" controls="" poster="video/cover.png">
    ...
    <div class="call-to-action background-grey m-b-0">
        <div class="container">
            ...
            <div class="col-md-6 col-lg-3 text-center "> <a class="btn btn-lg " href="aboutus.php">About Us</a> </div>
        </div>
    </div>
    <div class="container">
    <div class="p-t-80">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="widget widget-gallery">
                    ...
                    <div data-lightbox="gallery">
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/5.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/5.jpg">
                        </a>
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/6.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/6.jpg">
                        </a>
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/7.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/7.jpg">
                        </a>
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/8.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/8.jpg">
                        </a>
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/9.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/9.jpg">
                        </a>
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/10.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/10.jpg">
                        </a>
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/11.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/11.jpg">
                        </a>
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/12.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/12.jpg">
                        </a>
                        <a href="homepages/magazine/{base_url()}assets/front-end/images/news/grid/13.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/{base_url()}assets/front-end/images/news/grid/13.jpg">
                        </a>
                    </div>
