        ...
        <section id="page-content">
            <div class="container">                            
                        <div id="blog">
                            ...
                            {foreach $data.related_news -> result() as $row}
                            <div class="post-item">
                                <div class="post-item-wrap">
                                    <div class="post-item-description">
                                        <span class="post-meta-date"><i class="fa fa-calendar-o"></i>{$row->waktu|date_format}</span>
                                        <h2><a href="{$row->isi}" target="_blank">{$row->judul}</a></h2>
                                        <p>{$row->ringkasan}</p>
                                        <a href="{$row->isi}" target="_blank">Read More <i class="fa fa-arrow-right"></i></a>
