          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body box-primary">
                      ...
                      <form role="form" data-toggle="validator" class="form-horizontal" action="{base_url()}announcement/save" name="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-footer">
                              <label for="inputPassword3" class="col-sm-2 control-label">&nbsp;</label>
                              <a href="{base_url()}Announcement">Cancel</a>
