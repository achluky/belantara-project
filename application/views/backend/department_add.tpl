          ...
          <div class="col-xs-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body box-primary">
                      <form role="form" data-toggle="validator" class="form-horizontal" action="{base_url()}department/save" name="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="nav-tabs-custom">
                                  ...
                                  <div class="tab-content">
                                    <div class="tab-pane active" id="competence_1">
                                      <textarea class="form-control" rows="3" placeholder="Isi Divisi" name="content_division_ID" required></textarea>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="competence_2">
                                      <textarea class="form-control" rows="3" placeholder="Isi Divisi" name="content_division_EN" required></textarea>
                                    </div>
                                  </div>
                                  <!-- /.tab-content -->
                                </div>
