<header class="main-header">
    ...
    <a href="{base_url()}" class="logo">
		<img src="{base_url()}assets/img/www.png" alt="www." />
		<b>WEB</b> IPB
	</a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                      <img src="{base_url('assets/img/DIDSI_small.jpg')}" class="user-image" alt="User Image">
					...
					<ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                                <img alt="User Image" src="{base_url('assets/img/DIDSI_medium.jpg')}" class="img-circle">
								<p>
                                ...
                                <li class="user-footer">
                                        <a class="btn btn-default btn-flat" href="{base_url('admin/logout')}">{lang('navigation.label.logout')}</a>
                                </li>
                            </ul>
                </li>
            </ul>
...
<aside class="main-sidebar affix">
    <section class="sidebar">
		<div class="profile">
                <ul>
                    <li>
                        <img src="{base_url('assets/img/DIDSI.jpg')}" class="user-image" alt="User Image">
                    </li>
