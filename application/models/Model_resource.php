...
class Model_resource extends CI_Model {
    ...
    public function get_listresource($limit)
    {
        if ($limit==null) {
            $l = 10;
        }else{
        ...
        $sql = "select * from berita_ini WHERE id_bahasa = '".$this->session->userdata('site_lang')."' and kategori='resource' ORDER BY waktu DESC";
    ...
    public function _get_datatables_query()
    {
        ...
        $this->db->where("kategori",'resource');
    ...
    public function get_datatables_resource()
    {
    ...
    public function get_resource($id, $id_bahasa="EN")
    {
        $sql = "select * from berita_ini WHERE id_bahasa= '".$id_bahasa."' and id_berita='".$id."'  and kategori='resource' ";
        $result = $this->db->query($sql);
        return $result->row();
    }

    public function update_resource($data, $image, $id_bahasa)
    {
        $update = array(
            'judul'=>$data['judul'],
    ...
    public function save_resource($data, $image)
    {
