...
class Model_wcu_academic_reputation_prestasi_newsletter extends CI_Model {
	...
	public function get_once_with_relation($table, $id)
    {
       ...
       $this->db
                    ->select('t1.ID, t1.NamaPrestasi, t1.NamaPenyelenggara, t1.Newsletter, t1.NamaMitraPempublikasi, t1.SitusWeb, t2.Tingkat, t1.Tahun')
                    ->from($table.' t1 ')
