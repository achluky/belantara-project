<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-10-31 16:37:31
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '122623937159f8923b21e893-52407981',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_59f8923b265574_92526191',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f8923b265574_92526191')) {function content_59f8923b265574_92526191($_smarty_tpl) {?>
...
assets/front-end/images/slider/gajah.jpg');">
    ...
    <!-- Slide 2 -->
    <div class="slide background-overlay-one kenburns" style="background-image:url('<?php echo base_url();?>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="widget widget-gallery">
                    ...
                    <div data-lightbox="gallery">
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/5.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/5.jpg">
                        </a>
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/6.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/6.jpg">
                        </a>
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/7.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/7.jpg">
                        </a>
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/8.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/8.jpg">
                        </a>
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/9.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/9.jpg">
                        </a>
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/10.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/10.jpg">
                        </a>
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/11.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/11.jpg">
                        </a>
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/12.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/12.jpg">
                        </a>
                        <a href="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/13.jpg" data-lightbox="gallery-item">
                            <img alt="image" src="homepages/magazine/<?php echo base_url();?>
assets/front-end/images/news/grid/13.jpg">
                        </a>
                    </div>
