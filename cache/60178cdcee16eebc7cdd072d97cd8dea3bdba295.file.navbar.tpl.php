<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-10-08 22:04:46
         compiled from "application/views/backend/navbar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:163932195659da84debdffa7-58205501%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60178cdcee16eebc7cdd072d97cd8dea3bdba295' => 
    array (
      0 => 'application/views/backend/navbar.tpl',
      1 => 1504155499,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '163932195659da84debdffa7-58205501',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59da84dedf3475_15019699',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59da84dedf3475_15019699')) {function content_59da84dedf3475_15019699($_smarty_tpl) {?><header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>
" class="logo">
		<img src="<?php echo base_url();?>
assets/img/www.png" alt="www." />
		<b>WEB</b> IPB
	</a>
...
"  alt="EN">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                      <img src="<?php echo base_url('assets/img/DIDSI_small.jpg');?>
" class="user-image" alt="User Image">
					...
					<ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                                <img alt="User Image" src="<?php echo base_url('assets/img/DIDSI_medium.jpg');?>
" class="img-circle">
								<p>
...
"><?php echo lang('navigation.label.logout');?>
</a>
                                </li>
                            </ul>
                </li>
...
<aside class="main-sidebar affix">
    <section class="sidebar">
		<div class="profile">
                <ul>
                    <li>
                        <img src="<?php echo base_url('assets/img/DIDSI.jpg');?>
" class="user-image" alt="User Image">
                    </li>
